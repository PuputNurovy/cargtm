            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="PersiapanAngkut.php"><i class="fa fa-tags fa-fw"></i> Persiapan Angkut Kargo</a>
                        </li>
                        <li>
                            <a class="aktif" href="pengambilanKargo.php"><i class="fa fa-flag fa-fw"></i> Pengambilan Kargo</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <table align="right">
                            ...
                            <button  class="btn btn-default bHijau" data-toggle="modal" data-target="#tambah"><i class="glyphicon glyphicon-pencil" ></i>
                                tambah
                            </button>
                            <!-- Modal -->
                                        ...
                                        <div class="modal-body">
                                            <table style="width: 550px">
                                                    <tr width="100px" height="60px">
                                                        <td style="width: 200px">Id Kapal</td>
