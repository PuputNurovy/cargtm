    ...
    <div id="wrapper">
        <!-- Navigation -->
            ...
            <div class="nav-header">
                ...
                <img src="<?php echo base_url(); ?>aset/img/logo.jpg" class="shadow" style="float:left; width:40px; margin:5px"><a class="head" href="<?php echo base_url(); ?>">Cargo Terminal Management</a>
            </div>
            <!-- /.navbar-header -->
