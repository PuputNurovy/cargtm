                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="aktif" href="restore.php">Restore</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li> 
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                    <table >
                            <tr width="400px">
                                <td style="width:200px;">Cari Database</td>
                            ...
                            <tr width="100px" height="80px">
                                <td align="right">
                                    </a><a href="#"><button type="button" class="btn btn-primary btn-sm bHijau">Restore</button></a>
                                </td>
