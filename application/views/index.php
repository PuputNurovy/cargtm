...
<head>
    ...
    <!-- cargtm -->
    <link href="aset/css/style-cargtm.css" rel="stylesheet">
                    ...
                    <div class="panel-body" >
                        <form role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="password" type="dropdown" value="">
                                </div>
                                <div class="checkbox">
                                    <label>
                                ...
                                <a href="manager(admin)" class="btn btn-lg btn-success btn-block bHijau">Login</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
